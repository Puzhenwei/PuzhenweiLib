...
import com.library.utilsfour.stream.StringBuilderWriter;
...
public class IOUtils {
     ...
     * <p/>
     * Equivalent to {@link InputStream#close()}, except any exceptions will be ignored. This is typically used
     * in finally blocks.
     * <p/>
     * Example code:
     * 
     ...
     * <p/>
     * Equivalent to {@link OutputStream#close()}, except any exceptions will be ignored. This is typically used
     * in finally blocks.
     * <p/>
     * Example code:
     * 
     ...
     * <p/>
     * Equivalent to {@link Socket#close()}, except any exceptions will be ignored. This is typically used in
     * finally blocks.
     * <p/>
     * Example code:
     * 
     ...
     * <p/>
     * Equivalent to {@link ServerSocket#close()}, except any exceptions will be ignored. This is typically
     ...
     * </ul>
     * It can be used in favor of {@link #toByteArray(InputStream)}, since it avoids unnecessary allocation and
     * copy of byte[].<br>
    ...
    public static InputStream toBufferedInputStream(InputStream input)
        throws IOException {
        return com.library.utilsfour.stream.ByteArrayOutputStream.toBufferedInputStream(input);
    }
    
    /**
     * Returns the given reader if it is a {@link BufferedReader}, otherwise creates a toBufferedReader for the
     * given reader.
     *
    ...
    public static byte[] toByteArray(InputStream input)
        throws IOException {
        com.library.utilsfour.stream.ByteArrayOutputStream output = new com.library.utilsfour.stream.ByteArrayOutputStream();
        copy(input, output);
     ...
     * {@link com.litesuits.common.io.IOUtils#toByteArray(InputStream, int)} to read into the byte array.
     ...
     *             {@link UnsupportedEncodingException} in version 2.2 if the encoding is not supported.
     * @since 1.1
     */
     ...
     * <p/>
     * This allows for the possibility that {@link InputStream#skip(long)} may not skip as many bytes as
     ...
     * <p/>
     * This allows for the possibility that {@link Reader#skip(long)} may not skip as many characters as
     * requested (most likely because of reaching EOF).
     *
     * @param input stream to skip
     ...
     * <p/>
     * This allows for the possibility that {@link InputStream#read(byte[], int, int)} may not read as many
